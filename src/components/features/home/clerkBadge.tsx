export function ClerkBadge({ children }: { children: React.ReactNode }) {
  return (
    <span className="relative bg-blue-50 px-[0.1875rem] font-medium text-blue-500 dark:bg-blue-950">
      {children}
