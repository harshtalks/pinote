    ...
    return (
      ...
      >
        {Icon && iconPlacement === "left" && (
          <div
            className={cn(
              "w-0 translate-x-[0%] pr-0 opacity-0 transition-all duration-200 group-hover:w-4 group-hover:translate-x-100 group-hover:pr-2 group-hover:opacity-100",
              iconClassName,
            )}
          >
            <Icon />
        ...
        {Icon && iconPlacement === "right" && (
          <div
            className={cn(
              "w-0 translate-x-[100%] pl-0 opacity-0 transition-all duration-200 group-hover:w-4 group-hover:translate-x-0 group-hover:pl-2 group-hover:opacity-100",
              iconClassName,
            )}
          >
            <Icon />
